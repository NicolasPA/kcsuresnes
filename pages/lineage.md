# Historical Lineage of Principal Karate Instructors at Karate Club Suresnes

```mermaid
graph TD
    A01["Pictorial representations of martial arts<br/>(-3000 BCE)<br/>Egypt, Mesopotamia"]
    -.-> A02["Mentions in the Vedas<br/>(-1500 BCE)<br/>India"]
    -.-> A03["Mentions in the Annals of Spring and Autumn<br/>(-500 BCE)<br/>China"]
    -.-> A04["Shaolin Temple: Buddhabhadra, Bodhidharma, Huiguang, Sengchou, Huike <br/>(~500)<br/>India → China"]
    A02 -.-> A04

    -.-> A05["36 families of Min from Kume<br/>(>1400)<br/>China → Okinawa"]
    A04 -.-> A06["Emissaries of the Chinese Empire<br/>(>1400)<br/>China → Okinawa"]
    -.-> A07["Nobility and elite of the Ryukyu Kingdom<br/>(1429–1879)<br/>Okinawa"]
    A05 -.-> A07
    A08["Other influences<br/>(>1300)<br/>Taiwan, Korea, Thailand, Malaysia, Indonesia"]
    A08 -.-> A07

    A04 -.-> A1["Kusanku<br/>(~1700)<br/>China"]
